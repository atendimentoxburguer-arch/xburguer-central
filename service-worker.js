const CACHE='xburguer-central-v15-1';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./assets/css/app.css','./assets/css/domain-management.css','./assets/img/logo.png','./assets/img/icon.svg','./assets/img/icon-maskable.svg','./assets/js/core.js','./assets/js/ui.js','./assets/js/orders.js','./assets/js/sales.js','./assets/js/operations.js','./assets/js/crm.js','./assets/js/management.js','./assets/js/salon-management.js','./assets/js/menu-management.js','./assets/js/app.js','./assets/js/pwa.js'];
